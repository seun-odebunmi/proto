if (!localStorage.getItem('deviceID')) {
  const d = new Date().getMilliseconds().toString()
...
let aesLib = null
const KEY_SIZE = 256
const ITERATION_COUNT = 23
const SALT = '4321'
const IV = '15927644711979083751743559218983' // '12345678909876541234567890987654'
const KEY = deviceID //globals.deviceID

// export class AESEncryptionUtil {
//   static getInstance() {
//     if (!aesLib) {
//       aesLib = new AesUtil(KEY_SIZE, ITERATION_COUNT)
//     }
//     return aesLib
//   }

//   static encryptText(textToEncrypt) {
//     let encryptedText = AESEncryptionUtil.getInstance().encrypt(
//       SALT,
//       IV,
//       KEY,
//       textToEncrypt
...
//   static decryptText(textToDecrypt) {
//     let decryptedText = AESEncryptionUtil.getInstance().decrypt(
//       SALT,
//       IV,
//       KEY,
//       textToDecrypt
...
encryptionUtil.prototype.encryptText = function(textToEncrypt) {
  let encryptedText = this.getInstance().encrypt(SALT, IV, KEY, textToEncrypt)
  return encryptedText
}

encryptionUtil.prototype.decryptText = function(textToDecrypt) {
  let decryptedText = this.getInstance().decrypt(SALT, IV, KEY, textToDecrypt)
  return decryptedText
}

export const AESEncryptionUtil = new encryptionUtil()
