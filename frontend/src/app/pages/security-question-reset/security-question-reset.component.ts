...
@Component({
  selector: 'app-security-question-reset',
  templateUrl: './security-question-reset.component.html',
  styleUrls: ['./security-question-reset.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class SecurityQuestionResetComponent implements OnInit {
  ...
  constructor(
    ...
    private securityQuestionResetService: SecurityQuestionResetService,
  ...
  onReset() {
    ...
    this.securityQuestionResetService.resetSecurity(body).subscribe(
      data => {
        this.isRequesting = false
